...
export function NavIconExplore({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function NavIconInsights({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M4 19V5M4 19h16M8 19V9m4 10V6m4 13v-7"
      />
    </svg>
  );
}
...
export function NavIconSync({ className }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function NavIconForHref({
  ...
  href: keyof typeof NAV_ICON_MAP;
  className?: string;
}) {
